...
"""
Example usage:
    data-gather.py @support 50 data-tweets-line-separated-json.txt

Substitute your company's twitter handle instead of @support and
...
This will produce a file called data-tweets-line-separated-json.txt. It is used by
later scripts.
"""
...
max_tweets = sys.argv[2] # max number of tweets that this script downloads.
